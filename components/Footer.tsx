      ...
      <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1.1fr_0.9fr_0.9fr]">
        <div>
          ...
          <p className="mt-5 max-w-md leading-7 text-neutral-600">
            Kurumsal projeler için ankastre, iklimlendirme, enerji, görüntüleme,
            su arıtma ve elektrikli araç şarj çözümleri.
          </p>
          ...
          <div className="mt-5 flex flex-wrap gap-3">
            <a
              ...
              className="rounded-full bg-neutral-100 px-4 py-2 text-sm font-semibold text-neutral-800 transition hover:bg-red-50 hover:text-red-700"
            >
              Instagram
            </a>
          ...
          <div className="mt-4 grid gap-2">
            {navItems.map((item) => (
              <Link
                key={item.href}
                href={item.href}
                className="text-sm text-neutral-600 transition hover:text-red-700"
              >
                {item.label}
              </Link>
            ))}
        ...
        <div>
          ...
          <div className="mt-4 grid gap-3 text-sm leading-6 text-neutral-600">
            ...
            <a
              ...
              className="font-semibold text-neutral-950 transition hover:text-red-700"
            >
              {company.phone}
            </a>
